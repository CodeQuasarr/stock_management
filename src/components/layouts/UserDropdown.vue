...
<template>
    <div class="relative" ref="userDropdownRef">
        <button @click="setIsOpen(!isOpen)"
                class="flex items-center space-x-2 hover:bg-gray-50 rounded-lg p-2"
        >
            <img
                :src="user.avatar"
                alt="User avatar"
        ...
        <div v-if="isOpen" class="absolute right-0 mt-2 w-56 bg-white rounded-lg shadow-lg border border-gray-200 py-1 z-50">
