...
const menuItems = [
    ...
    { to: '/team', icon: 'ri:team-line', text: 'Joueurs' },
    { to: '/statistics', icon: 'lineicons:stats-up', text: 'Statistics' },
    { to: '/schedule', icon: 'uil:schedule', text: 'Schedule' },
]
...
<!--                    <UIcon name="tabler:play-basketball" class="h-8 w-8 text-indigo-600" />-->
                    <h1 class="text-2xl font-bold text-gray-800">CoachPro</h1>
                    <button
